...
public class JobRoleValidator {
    ...
    public String isValidJobRole(JobRoleRequest jobRoleRequest) throws JobRoleNameLengthException, JobFamilyGroupIdException, JobBandLevelIdException, JobRoleSpecLengthException, JobRoleLinkLengthException, JobResponsibilitiesLengthException {
        try {
